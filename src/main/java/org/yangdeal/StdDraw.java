 ...
 *  Compilation:  javac org.yangdeal.StdDraw.java
 *  Execution:    java org.yangdeal.StdDraw
 *  Dependencies: none
 *
...
/**
 *  The {@code org.yangdeal.StdDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use standard drawing, you must have {@code org.yangdeal.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">org.yangdeal.StdDraw.java</a>
 ...
 *           org.yangdeal.StdDraw.setPenRadius(0.05);
 *           org.yangdeal.StdDraw.setPenColor(org.yangdeal.StdDraw.BLUE);
 *           org.yangdeal.StdDraw.point(0.5, 0.5);
 *           org.yangdeal.StdDraw.setPenColor(org.yangdeal.StdDraw.MAGENTA);
 *           org.yangdeal.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code org.yangdeal.StdDraw.line()} and {@code org.yangdeal.StdDraw.point()}
 *  draw lines and points; the methods {@code org.yangdeal.StdDraw.setPenRadius()}
 *  and {@code org.yangdeal.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code org.yangdeal.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   org.yangdeal.StdDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code org.yangdeal.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code org.yangdeal.StdDraw.setPenColor(org.yangdeal.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code org.yangdeal.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code org.yangdeal.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   org.yangdeal.StdDraw.setFont(font);
 *   org.yangdeal.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code org.yangdeal.StdDraw.clear(org.yangdeal.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   org.yangdeal.StdDraw.setScale(-2, +2);
 *   org.yangdeal.StdDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       org.yangdeal.StdDraw.clear();
 *       org.yangdeal.StdDraw.filledCircle(x, y, 0.05);
 *       org.yangdeal.StdDraw.filledCircle(-x, -y, 0.05);
 *       org.yangdeal.StdDraw.show();
 *       org.yangdeal.StdDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     * {@code org.yangdeal.StdDraw.BLACK}, {@code org.yangdeal.StdDraw.BLUE}, {@code org.yangdeal.StdDraw.CYAN},
     * {@code org.yangdeal.StdDraw.DARK_GRAY}, {@code org.yangdeal.StdDraw.GRAY}, {@code org.yangdeal.StdDraw.GREEN},
     * {@code org.yangdeal.StdDraw.LIGHT_GRAY}, {@code org.yangdeal.StdDraw.MAGENTA}, {@code org.yangdeal.StdDraw.ORANGE},
     * {@code org.yangdeal.StdDraw.PINK}, {@code org.yangdeal.StdDraw.RED}, {@code org.yangdeal.StdDraw.WHITE}, and
     * {@code org.yangdeal.StdDraw.YELLOW}.
     *
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to org.yangdeal.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to org.yangdeal.StdDraw)
        try {
            URL url = org.yangdeal.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        }
        catch (IOException e) {
